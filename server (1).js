...
IMPORTANTE: El análisis debe ser 100% personalizado. NUNCA uses datos genéricos.
  ...
  try {
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        max_tokens: 2000,
        messages: [
          { role: 'system', content: 'Eres un experto en LinkedIn y trabajo remoto. Siempre respondés SOLO con JSON válido, sin markdown ni texto extra.' },
